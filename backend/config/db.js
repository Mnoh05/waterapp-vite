...
const createSolicitudMaterialModel = require("../models/SolicitudMaterial");
const createSolicitudMaterialDetallesModel = require("../models/SolicitudMaterialDetalle");
...
const SolicitudMaterial = createSolicitudMaterialModel(sequelize);
const SolicitudMaterialDetalles =createSolicitudMaterialDetallesModel(sequelize);
...
// Módulo y SolicitudMaterial
SolicitudMaterial.belongsTo(modulo, { foreignKey: "moduloId", as: "moduloSM" });
modulo.hasMany(SolicitudMaterial, { foreignKey: "moduloId",as: "solicitudes"});
// SolicitudMaterial y Detalles
SolicitudMaterial.hasMany(SolicitudMaterialDetalles, {foreignKey: "solicitudId", as: "detalles"});
SolicitudMaterialDetalles.belongsTo(SolicitudMaterial, { foreignKey: "solicitudId", as: "solicitud"});
